...
import './Navbar.css'; // تأكد من إنشاء ملف CSS
        ...
        <>
            ...
            <nav className="social-navbar">
                <div className="left">
                    ...
                    <div className='icon2'>
                    <h3 href="Sunny Isles Beach, FL 33160">Sunny Isles Beach, FL 33160
